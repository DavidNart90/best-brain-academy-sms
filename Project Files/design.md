...
- Staff profiles use the same compact record language with employment details, a bounded class-assignment history table, explicit add/end/archive actions, visible creator/updater context, and a permission-gated bounded salary history. State plainly that a staff profile is not a login account.
